...
class CodesignDDPGApeXagent:
    ...
    ####################################################################
    def update_step_from_buffer(self, buffer,policy_freq,tau):
        ...
        self.policy_update_cnt = (self.policy_update_cnt + 1) % policy_freq
        if self.policy_update_cnt == 0:
            ...
            for param, target_param in zip(self.critic.parameters(), self.critic_target.parameters()):
                target_param.data.copy_(self.tau * param.data + (1 - tau) * target_param.data)
