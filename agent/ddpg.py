...
class DDPGagent:
    ...
    def train(self, env,
       ...
       for episode in iterator:
            ...
            episode_a_energy_history = []
            episode_a_fcas_history = []
            #######################################################
            ...
            while not is_done:
                ...
                episode_a_energy_history.append(env.a_energy)
                episode_a_fcas_history.append(env.a_fcas)
            ...
            a_energy_history.append(episode_a_energy_history)
            a_fcas_history.append(episode_a_fcas_history)
            ...
            a_energy_df = pd.DataFrame(a_energy_history)
            a_fcas_df = pd.DataFrame(a_fcas_history)
            ...
            a_energy_df.to_csv(f'action/episode_a_energy_seed_{seed}_{current_datetime}.csv', index=False)
            a_fcas_df.to_csv(f'action/episode_a_fcas_seed_{seed}_{current_datetime}.csv', index=False)
