...
class CodesignEnergyEnv2:
    def __init__(self,mode = 'discrete'):
        self.mode = mode
        
        # データの読み込み
        self.solar_radiation_all = np.load("C:/Users/manta/OneDrive/ドキュメント/IEEE_TEMPR/data/sample_data_pv.npy") 
        self.solar_radiation = self.solar_radiation_all[4345:4345 + 24*7]
        self.market = pd.read_csv("C:/Users/manta/OneDrive/ドキュメント/IEEE_TEMPR/data/spot_summary_2022.csv", encoding='shift_jis')
