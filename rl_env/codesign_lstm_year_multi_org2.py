...
class MultiyearEnv:
    def __init__(self, agent_idx, mode, save_results=True):
        # データの読み込み
    ...
    def step(self, action):
        ...
        phi_pv, H_cr, lambda_ra = 0.4, 4.0, 11.54 # 8.31 * 12 / 8760
        ...
        if done and self.save_results and self.agent_idx == 'all':
            df = pd.DataFrame({
